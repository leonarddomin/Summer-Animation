...
const sun = new mojs.Shape({
  ...
  radius: {
    80: 80,
    curve:
      "M0, 55 C0, 55 4.377816206152662, 0.6791981139544082 35, 0 C49.269559298557965, -0.6791981139544124 100, 0 100, 0 ",
  },
  fill: "#f2b53c",
  top: {
    "100%": "100%",
    curve:
      "M0, 0 C39.838367550785236, 18.184188840192256 35, 50 35, 50 C35, 50 35.451230924059665, 28.66001019001613 36.578947368421055, 25 C37.44350591804561, 25.054275524269578 37.10526315789474, 25 37.10526315789474, 25 C37.10526315789474, 25 38.421052631578945, 25 38.421052631578945, 25 C38.421052631578945, 25 38.515036988498764, 25.000309160422404 40, 25 C40.43233143255387, 44.713976553863304 41.57894736842105, 67 41.57894736842105, 67 C41.57894736842105, 67 42.631580257102065, 50 42.631580257102065, 50 C42.631580257102065, 50 44.16491514576696, 49.775933714023616 45, 50 C53.7298216963383, 49.9383520002621 75, 50 75, 50 C75, 50 100, 50 100, 50 ",
  },
  left: {
    "50%": "50%",
    curve:
      "M0, 0 C0, 0 37.34375, 0 37.34375, 0 C37.34375, 0 38.28125, -25 38.28125, -25 C38.28125, -25 38.4895838991118, 25 38.4895838991118, 25 C38.4895838991118, 25 40, 25 40, 25 C40, 25 40.204190583136466, -0.03402878854698086 42.864583333333336, 0 C80.68122608353019, -0.2516854971673063 100, 0 100, 0 ",
  },
  scale: {
    1: 1,
    curve:
      "M0, 0 C0, 0 40, 0 40, 0 C40, 0 40, -10 40, -10 C40, -10 54.898474554477886, 1.5300968740935301 65, 0 C83.76056573985625, -0.14581880348632215 97.49152542372882, -150 97.49152542372882, -150 C97.49152542372882, -150 100.05828084987742, -520.6127602687636 100, -622.1428571428571 ",
  },
  duration: 42000,
  opacity: {
    1: 1,
    curve:
      "M0, 0 C0, 0 97.28571428571428, 0 97.28571428571428, 0 C97.28571428571428, 0 100, 100 100, 100 ",
  },
});
...
const circle = new mojs.Shape({
  ...
  radius: {
    0: 600,
    curve: "M0, 100 C0, 100 102.9451202760322, -73.92696952006735 100, -150",
  },
  duration: 1100,
  opacity: { 1: 0.2 },
  repeat: 38,
...
const finalTimeline = new mojs.Timeline({}).add(
  sphere,
  triangle,
  triangle2,
  rectangle
...
const circleTimeline = new mojs.Timeline({}).add(
  sun,
  sun2,
  explosion,
  explosion2,
